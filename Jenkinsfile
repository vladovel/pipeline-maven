pipeline {
    ...
    stages {
		...
		scp -i /home/jenkins/.ssh/id_rsa /tmp/.auth docker_user@192.168.1.206:/tmp/.auth		
		scp -i /home/jenkins/.ssh/id_rsa ./jenkins/deploy/publish.sh docker_user@192.168.1.206:/tmp/publish.sh
